...
var HostConfig = {
  ...
  createInstance: (type, newProps, rootContainerInstance2, _currentHostContext2, workInProgress2) => {
    ...
    const uid = getUid();
    const instance = createInstance(newProps, rootContainerInstance2, _currentHostContext2, workInProgress2, uid);
...
var ViewConfig = class {
  ...
  createInstance(newProps, rootInstance, context, workInProgress2, uid) {
