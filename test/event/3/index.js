...
function setStyle(comp, obj, compName, type, oldObj, isInit = true) {
  ...
  obj = style_default.transform(obj, compName);
...
function setTextareaProps(comp, newProps, oldProps) {
  const setter = {
    set style(styleSheet) {
      setStyle(comp, Array.isArray(styleSheet) ? [defaultStyle, ...styleSheet] : [defaultStyle, styleSheet], "Input", 0, oldProps.style);
    },
    set focusStyle(styleSheet) {
      setStyle(comp, Array.isArray(styleSheet) ? [defaultFocusStyle, ...styleSheet] : [defaultFocusStyle, styleSheet], "Input", 2, oldProps.focusStyle);
    },
    set onChange(fn) {
      handleEvent(comp, fn, EVENTTYPE_MAP.EVENT_VALUE_CHANGED);
    },
...
var TextareaComp = class extends NativeView2 {
  ...
  setStyle(style2, type = 0) {
    setStyle(this, style2, "Textarea", type, {}, false);
  }
};
...
function setInputProps(comp, newProps, oldProps) {
  const setter = {
    set style(styleSheet) {
      setStyle(comp, Array.isArray(styleSheet) ? [defaultStyle2, ...styleSheet] : [defaultStyle2, styleSheet], "Input", 0, oldProps.style);
    },
    set onChange(fn) {
      handleEvent(comp, fn, EVENTTYPE_MAP.EVENT_VALUE_CHANGED);
    },
    ...
    set focusStyle(styleSheet) {
      setStyle(comp, Array.isArray(styleSheet) ? [defaultFocusStyle2, ...styleSheet] : [defaultFocusStyle2, styleSheet], "Input", 2, oldProps.focusStyle);
    },
    set value(str) {
      comp.setText(str);
    },
...
var InputComp = class extends NativeView3 {
  ...
  setStyle(style2, type = 0) {
    setStyle(this, style2, "Input", type, {}, false);
  }
};
...
var NativeAnimate = bridge10.NativeRender.Animate;
var callbackObj = {};
